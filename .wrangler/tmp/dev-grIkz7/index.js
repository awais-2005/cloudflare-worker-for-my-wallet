...
async function deleteById(c) {
  ...
  try {
    ...
    c.json({ statusCode: 200, message: `user with id: ${userId} has been deleted.` });
  } catch (e) {
...
function handleTransactionRoutes(app2) {
  ...
  app2.post("/transactions", authGuard, createTransaction);
}
...
// .wrangler/tmp/bundle-TmX451/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TmX451/middleware-loader.entry.ts
